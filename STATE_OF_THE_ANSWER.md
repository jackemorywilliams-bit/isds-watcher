...
**China NMPA 2026 — new Ring 1 foundation:** China's May 2026 Implementation Measures for Drug Trial Data Protection create formal, protectable, and tradable entitlements in clinical trial data and marketing authorisation certificates — potentially qualifying as covered investments under China's BIT network (109 BITs in force) if subsequently restricted or unevenly applied. Sources: [(Ropes & Gray, May 2026)](https://www.ropesgray.com/en/insights/alerts/2026/05/chinas-nmpa-issues-final-measures-on-regulatory-data-protection); [(Arnold & Porter, Apr 2025)](https://www.arnoldporter.com/en/perspectives/advisories/2025/04/china-new-regulatory-data-protection-and-exclusivity-mechanism)
...
**UNCITRAL WG III Denial of Benefits Reform — trajectory updated through June 2026:** Working Paper A/CN.9/WG.III/WP.244 proposed extending DOB doctrine (Draft Provision 17) to shell companies, misuse, and sanctioned entities. At the April 2025 (51st) session, pushback threatened to reduce the reform to codification of existing practice only. Subsequent developments: WP.253 (mid-2025) renumbered the provision as Draft Provision 9 and maintained the shell-company and third-party-funding extensions; the 9th intersessional (November 2025, Santiago) and the 53rd session (January 12–16, 2026, New York) converged on a procedural Protocol as the July 2026 Commission deliverable. The 54th session (March 23–27, 2026, Vienna) focused on draft statutes for permanent first-tier and appellate tribunals; the Protocol structure was confirmed. The UNCITRAL 59th Commission session (June 29–July 10, 2026, New York) is the delivery moment: the key document is **A/CN.9/1246** ("Draft supplementary provisions on the conduct of proceedings"), covering evidence, bifurcation, interim measures, manifest lack of legal merit, security for costs, TPF disclosure, counterclaims, and cost allocation — procedural provisions only. The DOB provision (Draft Provision 9) is **not included** in A/CN.9/1246. The natural-person nationality-planning gap (Jason Yu Song scenario) is **not addressed** by the July 2026 package. Ring 3 doctrine architecture is unchanged pending the Commission session outcome (expected by July 10, 2026). Next active WG III milestone: October 12–16, 2026 session in Vienna (tentative). Sources: [(UNCITRAL, A/CN.9/1246)](https://uncitral.un.org/sites/default/files/2026-04/a_cn9_1246_advance_copy.pdf); [(UNCITRAL, WP.253)](https://uncitral.un.org/sites/uncitral.un.org/files/media-documents/uncitral/en/wp.253_draft_provisions_initial_draft_for_website.pdf); [(IISD ITN, 54th session, April 2026)](https://www.iisd.org/itn/2026/04/21/uncitral-working-group-iii-advances-isds-reform-but-progress-remains-slow/); [(EJIL:Talk!, 53rd Session)](https://www.ejiltalk.org/time-form-and-coalitions-reflections-on-the-53rd-session-of-uncitral-working-group-iii/)
...
3. **China NMPA 2026** — the Ring 1 foundation is established (domestic law side); European BIT Ring 1 bases confirmed (Germany, Switzerland, France); any subsequent restriction or uneven application of pharmaceutical data exclusivity protections could generate a claim under one of the three European BITs.
4. **UNCITRAL WG III DOB reform** — the 59th Commission session (June 29–July 10, 2026, New York) is the current active milestone; A/CN.9/1246 (procedural Protocol only) is the deliverable; DOB provision not in the package; natural-person gap unaddressed; next WG III session October 2026.
5. **"Data in Dispute" scholarship line** — practitioner literature is beginning to theorise data-as-investment ISDS; monitoring for new scholarship and any eventual filing.
