# ISDS Thematic Watch — 2026-09-07

**Screened: 30 · Matches (≥40): 0 · Watch-list leads: 0 · Watch-list leads shown (total): 0**

> ⚠️ **SOURCE DEGRADATION WARNING — documented-active sources with 3+ consecutive zero-item runs: icsid (DEGRADED (3 zero runs)). Their fetchers likely no longer match the live site; zero items from them is NOT evidence of a quiet week.**
